...
function CurveTip({
  ...
  const copy =
    d.state === 'sold'
      ? 'Already claimed — this is what it went for.'
      : d.state === 'current'
        ? 'You’re buying at this price right now.'
        : `Price once ${d.n} tables are gone.`;
  return (
    <div
    ...
    >
      ...
      <div style={{ marginTop: 10, fontSize: 11.5, lineHeight: 1.75, color: 'var(--ink-70)' }}>
        ...
        <Row label="Scarcity premium" value={`$${d.premium.toFixed(2)}`} />
